...
namespace AdformTrackingBindingiOS {
	...
	public unsafe partial class AFTrackPoint : NSObject {
		...
		[CompilerGenerated]
		public AFTrackPoint (global::System.nint trackingPointId)
		...
		public virtual AFOrder[] Order {
			...
			get {
				AFOrder[] ret;
				if (IsDirectBinding) {
					ret = NSArray.ArrayFromHandle<AFOrder>(global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("order")));
				} else {
					ret = NSArray.ArrayFromHandle<AFOrder>(global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("order")));
				}
				return ret;
			}
			...
			set {
				...
				if (IsDirectBinding) {
					global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setOrder:"), nsa_value.Handle);
				} else {
					global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("setOrder:"), nsa_value.Handle);
				}
				nsa_value.Dispose ();
		...
		[CompilerGenerated]
		public virtual global::System.nint TrackPointId {
